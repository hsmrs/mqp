#ifndef _TURTLEBOT_NODE_H_
#define _TURTLEBOT_NODE_H_
...
#include "turtlebot/Behavior.h"
#include "turtlebot/FollowTagBehavior.h"
#include "turtlebot/GoToBehavior.h"
#include "turtlebot/SearchBehavior.h"
...
public:
	Turtlebot(std::string name, double speed);
