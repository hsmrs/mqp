#ifndef _HUSKY_NODE_H_
#define _HUSKY_NODE_H_
...
#include "husky/GoToBehavior.h"
#include "husky/SearchBehavior.h"
...
public:
	Husky(std::string name, double speed);
